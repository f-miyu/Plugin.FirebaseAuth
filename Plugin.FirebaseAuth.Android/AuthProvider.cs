...
namespace Plugin.FirebaseAuth
{
    ...
    {
        private static readonly ConcurrentDictionary<Firebase.Auth.FirebaseAuth, Lazy<AuthWrapper>> _auths = new ConcurrentDictionary<Firebase.Auth.FirebaseAuth, Lazy<AuthWrapper>>();
