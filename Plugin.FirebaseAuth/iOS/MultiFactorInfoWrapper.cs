...
namespace Plugin.FirebaseAuth
{
    public class MultiFactorInfoWrapper : IMultiFactorInfo, IEquatable<MultiFactorInfoWrapper>
    {
        ...
        public DateTimeOffset EnrollmentDate => new DateTimeOffset(2001, 1, 1, 0, 0, 0, TimeSpan.Zero).AddSeconds(_multiFactorInfo.EnrollmentDate.SecondsSinceReferenceDate);
